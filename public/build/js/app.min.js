...
var g={clone:d};j.push(g),a.enter(d,f.parent(),f)})})})}}}],Og=gd({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,b,c,d,e){d.cases["!"+c.ngSwitchWhen]=d.cases["!"+c.ngSwitchWhen]||[],d.cases["!"+c.ngSwitchWhen].push({transclude:e,element:b})}}),Pg=gd({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,b,c,d,e){d.cases["?"]=d.cases["?"]||[],d.cases["?"].push({transclude:e,element:b})}}),Qg=b("ngTransclude"),Rg=gd({restrict:"EAC",link:function(a,b,c,d,e){function f(a){a.length&&(b.empty(),b.append(a))}if(c.ngTransclude===c.$attr.ngTransclude&&(c.ngTransclude=""),!e)throw Qg("orphan","Illegal use of ngTransclude directive in the template! No parent directive that requires a transclusion found. Element: {0}",Z(b));var g=c.ngTransclude||c.ngTranscludeSlot;e(f,null,g)}}),Sg=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(b,c){if("text/ng-template"==c.type){var d=c.id,e=b[0].text;a.put(d,e)}}}}],Tg={$setViewValue:n,$render:n},Ug=["$element","$scope",function(b,c){var d=this,e=new $a;d.ngModelCtrl=Tg,d.unknownOption=Id(a.document.createElement("option")),d.renderUnknownOption=function(a){var c="? "+Za(a)+" ?";d.unknownOption.val(c),b.prepend(d.unknownOption),b.val(c)},c.$on("$destroy",function(){d.renderUnknownOption=n}),d.removeUnknownOption=function(){d.unknownOption.parent()&&d.unknownOption.remove()},d.readValue=function(){return d.removeUnknownOption(),b.val()},d.writeValue=function(a){d.hasOption(a)?(d.removeUnknownOption(),b.val(a),""===a&&d.emptyOption.prop("selected",!0)):null==a&&d.emptyOption?(d.removeUnknownOption(),b.val("")):d.renderUnknownOption(a)},d.addOption=function(a,b){if(b[0].nodeType!==ee){ma(a,'"option value"'),""===a&&(d.emptyOption=b);var c=e.get(a)||0;e.put(a,c+1),d.ngModelCtrl.$render(),zd(b)}},d.removeOption=function(a){var b=e.get(a);b&&(1===b?(e.remove(a),""===a&&(d.emptyOption=void 0)):e.put(a,b-1))},d.hasOption=function(a){return!!e.get(a)},d.registerOption=function(a,b,c,e,f){if(e){var g;c.$observe("value",function(a){s(g)&&d.removeOption(g),g=a,d.addOption(a,b)})}else f?a.$watch(f,function(a,e){c.$set("value",a),e!==a&&d.removeOption(e),d.addOption(a,b)}):d.addOption(c.value,b);b.on("$destroy",function(){d.removeOption(c.value),d.ngModelCtrl.$render()})}}],Vg=function(){function a(a,b,c,e){var f=e[1];if(f){var g=e[0];if(g.ngModelCtrl=f,b.on("change",function(){a.$apply(function(){f.$setViewValue(g.readValue())})}),c.multiple){g.readValue=function(){var a=[];return d(b.find("option"),function(b){b.selected&&a.push(b.value)}),a},g.writeValue=function(a){var c=new $a(a);d(b.find("option"),function(a){a.selected=s(c.get(a.value))})};var h,i=NaN;a.$watch(function(){i!==f.$viewValue||P(h,f.$viewValue)||(h=O(f.$viewValue),f.$render()),i=f.$viewValue}),f.$isEmpty=function(a){return!a||0===a.length}}}}function b(a,b,c,d){var e=d[1];if(e){var f=d[0];e.$render=function(){f.writeValue(e.$viewValue)}}}return{restrict:"E",require:["select","?ngModel"],controller:Ug,priority:1,link:{pre:a,post:b}}},Wg=["$interpolate",function(a){return{restrict:"E",priority:100,compile:function(b,c){if(s(c.value))var d=a(c.value,!0);else{var e=a(b.text(),!0);e||c.$set("value",b.text())}return function(a,b,c){var f="$selectController",g=b.parent(),h=g.data(f)||g.parent().data(f);h&&h.registerOption(a,b,c,d,e)}}}}],Xg=p({restrict:"E",terminal:!1}),Yg=function(){return{restrict:"A",require:"?ngModel",link:function(a,b,c,d){d&&(c.required=!0,d.$validators.required=function(a,b){return!c.required||!d.$isEmpty(b)},c.$observe("required",function(){d.$validate()}))}}},Zg=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){if(e){var f,g=d.ngPattern||d.pattern;d.$observe("pattern",function(a){if(v(a)&&a.length>0&&(a=new RegExp("^"+a+"$")),a&&!a.test)throw b("ngPattern")("noregexp","Expected {0} to be a RegExp but was {1}. Element: {2}",g,a,Z(c));f=a||void 0,e.$validate()}),e.$validators.pattern=function(a,b){return e.$isEmpty(b)||r(f)||f.test(b)}}}}},$g=function(){return{restrict:"A",require:"?ngModel",link:function(a,b,c,d){if(d){var e=-1;c.$observe("maxlength",function(a){var b=l(a);e=isNaN(b)?-1:b,d.$validate()}),d.$validators.maxlength=function(a,b){return 0>e||d.$isEmpty(b)||b.length<=e}}}}},_g=function(){return{restrict:"A",require:"?ngModel",link:function(a,b,c,d){if(d){var e=0;c.$observe("minlength",function(a){e=l(a)||0,d.$validate()}),d.$validators.minlength=function(a,b){return d.$isEmpty(b)||b.length>=e}}}}};return a.angular.bootstrap?void(a.console&&console.log("WARNING: Tried to load angular more than once.")):(ja(),ta(Rd),Rd.module("ngLocale",[],["$provide",function(a){function b(a){a+="";var b=a.indexOf(".");return-1==b?0:a.length-b-1}function c(a,c){var d=c;void 0===d&&(d=Math.min(b(a),3));var e=Math.pow(10,d),f=(a*e|0)%e;return{v:d,f:f}}var d={ZERO:"zero",ONE:"one",TWO:"two",FEW:"few",MANY:"many",OTHER:"other"};a.value("$locale",{DATETIME_FORMATS:{AMPMS:["AM","PM"],DAY:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],ERANAMES:["Before Christ","Anno Domini"],ERAS:["BC","AD"],FIRSTDAYOFWEEK:6,MONTH:["January","February","March","April","May","June","July","August","September","October","November","December"],SHORTDAY:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],SHORTMONTH:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],STANDALONEMONTH:["January","February","March","April","May","June","July","August","September","October","November","December"],WEEKENDRANGE:[5,6],fullDate:"EEEE, MMMM d, y",longDate:"MMMM d, y",medium:"MMM d, y h:mm:ss a",mediumDate:"MMM d, y",mediumTime:"h:mm:ss a","short":"M/d/yy h:mm a",shortDate:"M/d/yy",shortTime:"h:mm a"},NUMBER_FORMATS:{CURRENCY_SYM:"$",DECIMAL_SEP:".",GROUP_SEP:",",PATTERNS:[{gSize:3,lgSize:3,maxFrac:3,minFrac:0,minInt:1,negPre:"-",negSuf:"",posPre:"",posSuf:""},{gSize:3,lgSize:3,maxFrac:2,minFrac:2,minInt:1,negPre:"-¤",negSuf:"",posPre:"¤",posSuf:""}]},id:"en-us",localeID:"en_US",pluralCat:function(a,b){var e=0|a,f=c(a,b);return 1==e&&0==f.v?d.ONE:d.OTHER}})}]),void Id(a.document).ready(function(){ea(a.document,fa)}))}(window),!window.angular.$$csp().noInlineStyle&&window.angular.element(document.head).prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>'),function(a){"use strict";function b(){return{restrict:"E",scope:!0,bindToController:{},controller:"BattleController as battleCtrl",templateUrl:"/src/components/battle.html"}}function c(a){function b(){var a;a=Math.floor(Math.random()*e[0].combos.length),c.enemy.combo={actions:JSON.parse(JSON.stringify(e[0].combos[a])),health:c.enemy.health||0,stamina:c.enemy.stamina||0},c.enemy.combo.health<=0&&alert("You win!"),c.enemy.combo.actions.forEach(function(a){c.enemy.combo.stamina+=a.effects.self.stamina})}var c;c=this,c.enemy={health:5,name:"Undead Warrior",stamina:5},c.player={combo:{actions:[],stamina:5},health:20,name:"Blasko",stamina:5,controls:d},c.addAction=function(a){c.player.combo.stamina+=a.effects.self.stamina,c.enemy.combo.health+=a.effects.assailant.health,c.player.combo.stamina<0?c.player.combo.stamina=0:c.player.combo.actions.push(JSON.parse(JSON.stringify(a)))},c.genArray=function(a){return new Array(a)},c.undo=function(){var a;a=c.player.combo.actions.splice(c.player.combo.actions.length-1,1),c.player.combo.stamina-=a[0].effects.self.stamina,c.enemy.combo.health-=a[0].effects.assailant.health},c.battle=function(){var d,e;d=0,e=function(){var f,g;switch(f=c.enemy.combo.actions[d],g=c.player.combo.actions[d],f.slug){case"A":"B"!==g.slug&&(c.player.health+=f.effects.assailant.health)}switch(c.enemy.stamina+=f.effects.self.stamina,g.slug){case"A":"B"!==f.slug&&(c.enemy.health+=g.effects.assailant.health)}c.player.stamina+=g.effects.self.stamina,f.isComplete=!0,g.isComplete=!0,++d!==c.enemy.combo.actions.length?a(e,800):(c.player.combo={actions:[],health:c.player.health,stamina:c.player.stamina},b())},a(e,800)},b()}var d,e;d=[{slug:"A",name:"Attack",effects:{assailant:{health:-2},self:{stamina:-3}}},{slug:"B",name:"Block",effects:{assailant:{},self:{stamina:-2}}},{slug:"R",name:"Rest",effects:{assailant:{},self:{stamina:3}}},{slug:"H",name:"Heal",effects:{assailant:{},self:{stamina:2,health:3}}}],e=[{name:"Undead Warrior",combos:[[{slug:"A",name:"Attack",effects:{assailant:{health:-5},self:{stamina:-2}}},{slug:"B",name:"Block",effects:{assailant:{},self:{stamina:-3}}},{slug:"R",name:"Rest",effects:{assailant:{},self:{stamina:2}}},{slug:"R",name:"Rest",effects:{assailant:{},self:{stamina:2}}}],[{slug:"R",name:"Rest",effects:{assailant:{},self:{stamina:2}}},{slug:"B",name:"Block",effects:{assailant:{},self:{stamina:-3}}},{slug:"A",name:"Attack",effects:{assailant:{health:-5},self:{stamina:-2}}},{slug:"B",name:"Block",effects:{assailant:{},self:{stamina:-3}}}],[{slug:"A",name:"Attack",effects:{assailant:{health:-5},self:{stamina:-2}}},{slug:"A",name:"Attack",effects:{assailant:{health:-5},self:{stamina:-2}}},{slug:"B",name:"Block",effects:{assailant:{},self:{stamina:-3}}},{slug:"R",name:"Rest",effects:{assailant:{},self:{stamina:2}}}]]}],c.$inject=["$timeout"],a.module("battle",[]).controller("BattleController",c).directive("stBattle",b)}(window.angular),angular.module("station.templates",[]).run(["$templateCache",function(a){a.put("/src/components/battle.html",'<div class="BattleController as battleCtrl"><div class=row><div class=col-6><div class=panel><div class=panel-heading><h4 ng-bind=battleCtrl.enemy.name></h4><div class=meter><span class=label>HP</span><div class=gauge><span ng-repeat="i in battleCtrl.genArray(battleCtrl.enemy.combo.health) track by $index">*</span></div><div class="gauge muted"><span ng-repeat="i in battleCtrl.genArray(battleCtrl.enemy.health) track by $index">*</span></div></div><div class=meter><span class=label>AP</span> <span ng-repeat="i in battleCtrl.genArray(battleCtrl.enemy.stamina) track by $index">-</span></div></div><div class=panel-body><span class=box ng-repeat="action in battleCtrl.enemy.combo.actions track by $index" ng-bind=action.name ng-class="{ \'muted\': action.isComplete }"></span></div></div></div><div class=col-6><div class=panel><div class=panel-heading><h4 ng-bind=battleCtrl.player.name></h4><div class=meter><span class=label>HP</span> <span ng-repeat="i in battleCtrl.genArray(battleCtrl.player.health) track by $index">*</span></div><div class=meter><span class=label>AP</span><div class=gauge><span ng-repeat="i in battleCtrl.genArray(battleCtrl.player.combo.stamina) track by $index">-</span></div><div class="gauge muted"><span ng-repeat="i in battleCtrl.genArray(battleCtrl.player.stamina) track by $index">-</span></div></div></div><div class=panel-body><span class=box ng-repeat="action in battleCtrl.player.combo.actions track by $index" ng-bind=action.name ng-class="{ \'muted\': action.isComplete }"></span><div class=battle-controls><button ng-repeat="control in battleCtrl.player.controls track by $index" ng-click=battleCtrl.addAction(control)><span ng-bind=::control.name></span> (<span ng-bind=::control.effects.self.stamina></span>)</button><br><button ng-click=battleCtrl.undo()>Undo</button><button ng-click=battleCtrl.battle()>Apply</button></div></div></div></div></div></div>')}]);
